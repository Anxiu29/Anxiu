...
const profile = (): KeyboardProfile => ({
  ...
  positions: [
    { id: 'a', sourceCode: 4, label: 'A', present: true, address: { kind: 'matrix', row: 0, column: 0 }, geometry: { x: 0, y: 0, width: 1, height: 1 } },
    { id: 'b', sourceCode: 5, label: 'B', present: true, address: { kind: 'matrix', row: 0, column: 1 }, geometry: { x: 1, y: 0, width: 1, height: 1 } },
  ],
  assignments: [
