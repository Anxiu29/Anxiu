...
<template>
  <main>
    ...
    <AppShell v-else :key="shellRevision" :profile="profile" :active-configuration="activeConfiguration" :navigation-disabled="busy()" :error="error" :message="message" :message-warning="messageWarning" :sidebar-image-url="devicePresentation.sidebarImageUrl" @select-configuration="store.selectConfiguration" @restore-factory="store.restoreFactory">
      ...
      <template #performance><PerformanceWorkspace :profile="profile" :status="status" :selected-position-id="selectedPositionId" :settings="performanceSettings" :loading="performanceLoading" :polling-rate="pollingRate" :travel-matrix="travelMatrix" :travel-reading="travelReading" :calibration-active="calibrationActive" :assignments="assignments" :key-labels="keyLabels" :key-geometry="devicePresentation.keyGeometry" @select-position="selectedPositionId = $event" @load="store.loadPerformance" @update="store.updatePerformance" @load-polling-rate="store.loadPollingRate" @update-polling-rate="store.updatePollingRate" @read-travel="store.readTravelMatrix" @start-calibration="store.startCalibration" @finish-calibration="store.finishCalibration" /></template>
